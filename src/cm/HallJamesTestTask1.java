...
public class HallJamesTestTask1 {
    ...
    //Rate class to prevent repetition
    private Rate testRateMethod(){
    ...
    public void test1Calculate() throws IllegalArgumentException {
        //Partitioned Test -> 0 ≤ startHour
        Rate rate = testRateMethod();

        Period per = new Period(0,24);

        BigDecimal outputExpected = new BigDecimal(100);
    ...
    public void test9Calculate() throws IllegalArgumentException {
        ...
        BigDecimal outputExpected = new BigDecimal(10);
